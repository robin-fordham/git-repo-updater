...
class RepoSearch:
    ...
    def get_lz_repo_list(self):
        ...
        """
        #Full list["ansible-nbs-lz-base", "horizon-elasticsearch-deployments", "horizon-logstash-module", "nbs-buildkite-terraform", "nbs-ctdf", "nbs-ecs-lambda", "nbs-eks", "nbs-example-terraform", "nbs-github-terraform", "nbs-helm-charts", "nbs-horizon", "nbs-k8s-deployments", "nbs-luminate-policies", "nbs-lz", "nbs-lz-account-vendor", "nbs-lz-ami-aws-inspector-report", "nbs-lz-ami-bakery", "nbs-lz-ami-bakery-aws-linux", "nbs-lz-ami-bakery-vtm", "nbs-lz-ami-bakery-windows", "nbs-lz-ami-cleanup", "nbs-lz-ami-compliance", "nbs-lz-ami-notify", "nbs-lz-ami-report", "nbs-lz-ansible-rhel8-base", "nbs-lz-aws-test", "nbs-lz-bk-autoscaler", "nbs-lz-bucket-emptier", "nbs-lz-buildkite-autoscaler", "nbs-lz-client-vpn", "nbs-lz-codepipeline", "nbs-lz-compliance-reporter", "nbs-lz-config-sechub-integration-lambda", "nbs-lz-container-bakery", "nbs-lz-container-bakery-2.0", "nbs-lz-container-bakery-move", "nbs-lz-cpu-credit-checker", "nbs-lz-cwlog-processor", "nbs-lz-east-west-palofirewalls", "nbs-lz-east-west-palofirewalls-config", "nbs-lz-ec2-scheduler", "nbs-lz-ecr", "nbs-lz-egress-allowlist", "nbs-lz-egress-config", "nbs-lz-egress-failover", "nbs-lz-egress-palofirewalls", "nbs-lz-egress-palofirewalls-config", "nbs-lz-eks-ami-patching", "nbs-lz-eks-ami-update-status", "nbs-lz-eks-ssm-ami", "nbs-lz-endpoint-monitor", "nbs-lz-epaas-eks", "nbs-lz-epaas-eks-apps", "nbs-lz-es-shipper", "nbs-lz-f5", "nbs-lz-f5-config", "nbs-lz-ft-extended-bk-permissions", "nbs-lz-github-alerts", "nbs-lz-github-authorizer", "nbs-lz-global-protect-palofirewalls", "nbs-lz-global-protect-palofirewalls-config", "nbs-lz-globalprotect", "nbs-lz-globalprotect-config", "nbs-lz-globalprotect-user-counter", "nbs-lz-ingress-avi", "nbs-lz-ip-space-checker", "nbs-lz-ipam", "nbs-lz-lambda-bakery", "nbs-lz-lambda-python-twistlock-layer", "nbs-lz-log-receiver", "nbs-lz-log-shipper", "nbs-lz-nacl-analyser", "nbs-lz-networking-dev", "nbs-lz-panorama", "nbs-lz-panorama-config", "nbs-lz-phd-event-handler", "nbs-lz-pocs", "nbs-lz-rds-scheduler", "nbs-lz-rhel-upgrade", "nbs-lz-sandbox", "nbs-lz-sechub-extract", "nbs-lz-sechub-workflow-lambda", "nbs-lz-secrets-report", "nbs-lz-service-policy-reporting", "nbs-lz-splunk-sorter", "nbs-lz-spoke-blueprints", "nbs-lz-suppress-resource-sechub-findings", "nbs-lz-tag-verifier", "nbs-lz-tagging-non-compliance-reporter", "nbs-lz-tdp-1", "nbs-lz-tdp-2", "nbs-lz-test-repo", "nbs-lz-thousandeyes", "nbs-lz-tooling-roles", "nbs-splunk-sechub-input", "nbs-splunk-terraform", "nbs-vault-policies", "terraform-aws-eks", "actions-checkout", "ansible-role-nbs-luminate-ssh-ca", "nbs-aad-registration", "nbs-ansible-cloudwatch-agent", "nbs-cloudad-infra", "nbs-finops", "nbs-pre-commit", "nbs-terraform-modules", "nbs-twistlock-config", "nbs-windows-ami-packer", "terraform-aws-elasticsearch", "terraform-compliance", "nbs-buildkite-terraform-provider", "nbs-compliance-dashboard", "nbs-eks-lambda", "nbs-eks-twistlock", "nbs-forensics-cado", "nbs-prismacloud-saas", "nbs-rbac-edbhub", "nbs-rbac-shared-default", "nbs-secops-utils", "nbs-splunk-ansible", "nbs-splunk-cluster-master", "nbs-splunk-deployer", "nbs-splunk-deployment-server", "nbs-splunk-saas-apps", "nbs-twistlock-aws", "nbs-twistlock-deployment-examples", "nbs-twistlock-epaas", "nbs-twistlock-saas", "nbs-vectr-aws"]
